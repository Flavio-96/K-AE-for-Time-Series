...
\end{itemize}
L'analisi di TS e la costruzione di un modello di machine learning per esse richiede di affrontare problematiche che non occorrono con altri tipi di dati. Ad esempio:
\begin{itemize}
